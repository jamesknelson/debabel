...
view._makeAll(
{
  "todos/index.html:title": "Todos",
  "todos/index.html:header": "<app:alert>",
  "todos/index.html:body": "<div id=overlay></div><form id=head x-bind=submit:add><h1>Todos <span>{_remaining} remaining</span></h1><div id=add><div id=add-input><input id=new-todo value={_newTodo}></div><input id=add-button type=submit value=Add></div></form><div id=dragbox></div><div id=content><ul id=todos>{#each _todoList}<app:todo>{/}</ul></div>",
  "todos/index.html:todo": "<li data-id={{id}} class=\"{#if .completed}completed{/}\"><table width=100%><tr><td class=handle width=0></td><td width=100%><div class=todo><label><input type=checkbox checked={.completed}><i></i></label><div x-bind=keydown:shortcuts contenteditable>{unescaped .text}</div></div></td><td width=0><button class=delete x-bind=click:del>Delete</button></td></tr></table></li>",
  "todos/index.html:alert": "<div id=alert>{#unless connected}<p>{#if canConnect}Offline {#if _showReconnect}&ndash; <a x-bind=click:connect>Reconnect</a>{/}{else}Unable to reconnect &ndash; <a x-bind=click:reload>Reload</a>{/}</p>{/}</div>",
  "todos/index.html:scripts": "<script src=https://ajax.googleapis.com/ajax/libs/jquery/1.7.1/jquery.min.js></script><script src=https://ajax.googleapis.com/ajax/libs/jqueryui/1.8.16/jquery-ui.min.js></script>"
}, {
  "title": [
    "todos/index.html:title",
    {}
  ],
  "header": [
    "todos/index.html:header",
    {}
  ],
  "body": [
    "todos/index.html:body",
    {}
  ],
  "todo": [
    "todos/index.html:todo",
    {}
  ],
  "alert": [
    "todos/index.html:alert",
    {}
  ],
  "scripts": [
    "todos/index.html:scripts",
    {}
  ]
});
